...
Ici les résultats bruts renvoient 2 facteurs latents. Mais 5 méthodes, ce qui est important, font également consensus autour d'un seul facteur, ce qui peut être tout à fait logique vu le petit nombre de variables que nous avons. C'est aussi une des forces de l'AFE de pouvoir faire émerger un seul facteur latent global au sein duquel se projeteraient toutes nos variables. C'est un résultat qui peut être très intéressant.
